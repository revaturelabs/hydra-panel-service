...
--------------------------------------------------------
	DROP TABLE IF EXISTS CALIBER_PANEL;
	
	CREATE TABLE IF NOT EXISTS CALIBER_PANEL(
	PANEL_ID INT(10) PRIMARY KEY,
	ASSOCIATE_INTRO VARCHAR(100),
	COMMUNICATION_SKILLS VARCHAR(100),
	DURATION VARCHAR(100),
	INTERVIEW_FORMAT VARCHAR(100) NOT NULL,
	INTERNET_CONNECTIVITY VARCHAR(100),
	INTERVIEW_DATE TIMESTAMP,
	OVERALL_FEEDBACK VARCHAR(30),
	PANEL_ROUND INT(10),
	PROJECT_ONE_DESCRIPTION VARCHAR(30),
	PROJECT_THREE_DESCRIPTION VARCHAR(30),
	PROJECT_TWO_DESCRIPTION VARCHAR(30),
	RECORDING_CONSENT VARCHAR(30),
	RECORDING_LINK VARCHAR(30),
	PANEL_STATUS VARCHAR(30) NOT NULL,
	PANELIST_ID INT(10),
	TRAINEE_ID INT(10)
	);
